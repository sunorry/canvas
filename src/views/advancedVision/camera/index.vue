<template>
  <div style="block">
    <p style="color: red;">这个 demo 实在用原生webgl写不动，用了 ogl</p>
...
import { Renderer, Camera, Transform, Sphere, Cylinder, Box, Torus, Program, Mesh } from 'ogl'
export default defineComponent({
  ...
  setup() {
    ...
    // }
    onMounted(() => {
      // const gl = useGL(canvas.value!)
      const renderer = new Renderer({ canvas: canvas.value!, width: 512, height: 512 })
